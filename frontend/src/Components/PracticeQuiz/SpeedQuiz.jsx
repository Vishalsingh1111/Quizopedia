...
import { Clock, Trophy, BookOpen, Star, Users, ChevronDown, Lightbulb, EyeOff, Timer } from 'lucide-react';
...
export default function QuizApp() {
        ...
        if (timerActive && timeLeft > 0) {
            timerIntervalRef.current = setInterval(() => {
                setTimeLeft(prevTime => {
                    ...
                    // Show warning when 1 minute (60 seconds) remaining
        ...
        try {
            ...
            if (response.data.mcqs && response.data.mcqs.length > 0) {
                ...
                if (timerEnabled) {
                    ...
                    setTimerActive(true);
                    toast.success(`✅ Quiz started with ${timerMinutes} minute timer!`);
                } else {
    ...
    const handleSubmit = async (isAutoSubmit = false) => {
        ...
        const submitMessage = isAutoSubmit
            ? `⏰ Time's up! Final Score: ${finalScore}/${mcqs.length}`
            : `🎉 Quiz completed! Score: ${finalScore}/${mcqs.length}`;

        toast.success(submitMessage, {
            duration: 4000
        });

        // Save to history (if you want to keep this functionality)
        try {
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <div className="text-center mb-12">
                        <div className="flex items-center justify-center mb-4">
                            ...
                            <h1 className="text-4xl md:text-5xl font-bold dark:text-white text-gray-900">AI Quiz Generator With Timer</h1>
                        </div>
                            ...
                            <div className="bg-white dark:bg-white/5 dark:backdrop-blur-md dark:text-white rounded-xl shadow-sm border border-gray-100 dark:border-white/10 overflow-hidden p-8">
                                <div className="flex justify-between items-center">
                                    ...
                                    <div className="text-right flex items-center space-x-4">
                                        ...
                                        <button
                                            className="hover:bg-purple-600 bg-purple-500 text-white font-semibold px-4 py-0 md:py-4 rounded-lg print:hidden"
